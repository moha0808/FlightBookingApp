...
import 'package:flightbookingapp/Signup.dart';
...
class _SignupPageState extends State<SignupPage> {
  ...
  // Future<void> addUserDetails(String username, String mobilenumber, String email) async {
            ...
            Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('images/bag.jpg'), // Replace with your background image
                  fit: BoxFit.cover,
                ),
              ),
              child: Opacity(
